...
export const ProfessionalTitleSearch = ({ form }: Props) => {
                        ...
                        <PopoverTrigger asChild>
                            <FormControl>
                                <Button
                                    variant="outline"
                                    role="combobox"
                                    className="dark:bg-transparent py-5 w-full h-10 justify-between text-sm rounded-lg border-muted-foreground/30 text-muted-foreground font-medium"
                                    ...
                                    <CommandGroup>
                                        {titles?.map((title) => (
                                            <CommandItem
                                                ...
                                                value={title}
                                                onSelect={() => {
                                                    field.onChange(title); // set form value
